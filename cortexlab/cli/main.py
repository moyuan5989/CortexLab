...
def build_parser() -> argparse.ArgumentParser:
    ...
    prepare_parser.add_argument(
        "--output",
        default=None,
        help="Ignored (kept for compat). Storage is in ~/.cortexlab/datasets/",
    )
    prepare_parser.add_argument(
        "--name",
        default=None,
    ...
    studio_parser = subparsers.add_parser(
        "studio",
        help="Start the CortexLab Studio web UI server",
    )
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.command == "prepare":
        from cortexlab.cli.prepare_cmd import run_prepare
        ...
        from cortexlab.cli.generate_cmd import run_generate

        run_generate(args)
    elif args.command == "data":
        from cortexlab.cli.data_cmd import run_data

        run_data(args)
    elif args.command == "studio":
        from cortexlab.cli.studio_cmd import run_studio
