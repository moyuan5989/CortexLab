"""Model and tokenizer loading for CortexLab v0.
...
def load_model(
    ...
    mlx-lm. It supports the architectures defined in the CortexLab registry.
    ...
    Note:
        ...
        before calling this function (see cortexlab.models.resolve).
