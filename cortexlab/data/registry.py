"""Dataset download, import, and management for CortexLab.

Manages the ~/.cortexlab/datasets/ directory structure:
...
from cortexlab.data.catalog import DATASET_CATALOG, DatasetProfile
...
class DatasetRegistry:
    ...
    def __init__(self, base_dir: str = "~/.cortexlab/datasets"):
    ...
    def download(
        ...
        *,
        ...
        print(f"Converting to CortexLab format ({profile.format})...")
