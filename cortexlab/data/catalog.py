"""Curated dataset catalog for CortexLab.
...
@dataclass
class ColumnMapping:
    """Defines how to convert HF dataset columns to CortexLab standard format."""
...
class DatasetProfile:
    ...
    columns: ColumnMapping | None = None  # How to convert to CortexLab format
