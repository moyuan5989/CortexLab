...
from cortexlab.data.batching import iterate_batches, iterate_packed_batches
from cortexlab.losses.sft import SFTLoss
from cortexlab.trainer.callbacks import CallbackList
from cortexlab.trainer.checkpoint import CheckpointManager
from cortexlab.trainer.optimizer import build_optimizer
...
def loss_fn(model, input_ids, labels):
    ...
    from cortexlab.losses.sft import loss_fn as _loss_fn
...
def loss_fn_packed(model, input_ids, labels, segment_ids):
    ...
    from cortexlab.losses.sft import loss_fn_packed as _loss_fn_packed
