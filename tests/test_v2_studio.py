...
@pytest.fixture
def app():
    return create_app(runs_dir="/tmp/mlx_forge_test_v2_studio")
...
class TestNewArchitectures:
    ...
    def test_qwen2_model_instantiation(self):
        ...
        from mlx_forge.models.architectures.qwen2 import Model, ModelArgs
    ...
    def test_phi4_model_instantiation(self):
        ...
        from mlx_forge.models.architectures.phi4 import Model, ModelArgs
...
class TestV2ContractPreservation:
    ...
    def test_loss_functions_accessible(self):
        ...
        from mlx_forge.trainer.trainer import loss_fn, loss_fn_packed
