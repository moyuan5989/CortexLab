"""Dataset download, import, and management for MLX Forge.

Manages the ~/.mlxforge/datasets/ directory structure:
...
from mlx_forge.data.catalog import DATASET_CATALOG, DatasetProfile
...
class DatasetRegistry:
    ...
    def __init__(self, base_dir: str = "~/.mlxforge/datasets"):
    ...
    def download(
        ...
        *,
        ...
        print(f"Converting to MLX Forge format ({profile.format})...")
