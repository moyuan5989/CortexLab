"""Curated dataset catalog for MLX Forge.
...
@dataclass
class ColumnMapping:
    """Defines how to convert HF dataset columns to MLX Forge standard format."""
...
class DatasetProfile:
    ...
    columns: ColumnMapping | None = None  # How to convert to MLX Forge format
