"""Handler for 'mlx_forge data' CLI commands.
...
def run_data(args) -> None:
    ...
    if subcmd is None:
        print("Usage: mlx_forge data {list|catalog|download|import|inspect|stats|delete}")
        return
...
def _run_list(args) -> None:
    ...
    if not datasets:
        print("No datasets downloaded. Use 'mlx_forge data catalog' to browse available datasets.")
        return
...
def _run_catalog(args) -> None:
    ...
    print("  Download: mlx_forge data download <id>")
